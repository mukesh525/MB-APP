 ...
 */
public class IvrsFollowUp extends Fragment implements Tag {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (args != null) {
            FollowupInfo = getArguments().getString("TrackInfo");
        }
        return view;
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                response=Parser.FollowUp(HomeActivity.BASE_URL + UPDATE_DETAILS_URL, HomeActivity.userData.getAUTHKEY(), trackDetailsFollowupArrayList,
                        mFollowupData.getCallId(),mFollowupData.getGroupName(),IVRS);
