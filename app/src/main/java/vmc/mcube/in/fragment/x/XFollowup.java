 ...
 */
public class XFollowup extends Fragment implements Tag {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (args != null) {
            XInfo = getArguments().getString("TrackInfo");
        }
        return view;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mXData = gson.fromJson(XInfo, XData.class);
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                response=Parser.FollowUp(HomeActivity.BASE_URL + UPDATE_DETAILS_URL, HomeActivity.userData.getAUTHKEY(), trackDetailsFollowupArrayList,
                        mXData.getCallId(), mXData.getGroupName(), "pbx");
